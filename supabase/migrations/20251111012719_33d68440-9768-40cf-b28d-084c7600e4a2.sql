-- Fix the trigger function to use the correct schema
DROP FUNCTION IF EXISTS public.notify_admin_new_booking() CASCADE;

-- Recreate with correct net schema reference
